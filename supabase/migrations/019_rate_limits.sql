...
CREATE INDEX IF NOT EXISTS idx_rate_limits_timestamp ON public.rate_limits(action_timestamp DESC);
CREATE INDEX IF NOT EXISTS idx_rate_limits_user_post ON public.rate_limits(user_id, post_id) WHERE post_id IS NOT NULL;
